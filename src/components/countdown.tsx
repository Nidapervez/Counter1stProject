...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-black text-white">
      {/* Timer box container */}
      <div className="bg-gradient-to-r from-gray-200 via-gray-400 to-gray-600 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md rounded-r-full rounded-l-full ">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-200 text-center">
          Countdown Timer Created By Nida
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 bg-black font-semibold"
          />
          <Button
